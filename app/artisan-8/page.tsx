    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        toast({
          ...
          description: "Thank you for your interest in Artisan 8 ! We have sent you a confirmation email and our team will contact you soon to arrange your showflat visit.",
          variant: "default",
        })
    ...
    >
      ...
      <section className="relative min-h-screen md:min-h-0 md:h-[50vh] lg:min-h-screen lg:h-auto flex items-center justify-center">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/artisan8/artisan8-hero-background.webp"
            alt="Artisan 8 Hero"
            fill
          ...
          <div className={`max-w-4xl transition-all duration-1000 delay-300 ${
            ...
            <div className={`mb-4 sm:mb-2 md:mb-2 lg:mb-6 transition-all duration-700 delay-700 ${
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white mb-2 sm:mb-2 md:mb-2 lg:mb-4 leading-tight">
                <span className={`transition-all duration-1000 delay-900 ${isVisible ? 'animate-fade-in-left' : ''}`}>ARTISAN 8</span>
              </h1>
        ...
        <div className={`absolute bottom-2 right-2 sm:bottom-4 sm:right-4 transition-all duration-1000 delay-2000 ${
          ...
          <p className="text-[9px] sm:text-xs text-white/70 bg-black/30 backdrop-blur-sm px-2 py-1 sm:px-3 sm:py-2 rounded-lg whitespace-nowrap">
            Images are for illustrative purposes only and may <br className="sm:hidden"/> not reflect the final design of Artisan 8.
          </p>
        </div>
      </section>
            ...
            <Card className="lg:col-span-4 border-gray-700 bg-[#18191b] hover:shadow-lg transition-all duration-500">
              ...
              <CardContent className="space-y-6">
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  ...
                  <span className="font-semibold text-white text-right">Artisan 8</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Developer:</span>
                  <span className="font-semibold text-white text-right">Apex Asia (2) Pte Ltd</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                ...
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  ...
                  <span className="font-semibold text-white text-right">D20 - Ang Mo Kio / Bishan / Thomson</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Address:</span>
                  <span className="font-semibold text-white text-right">8 Sin Ming Road, Singapore 575628</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Site Area:</span>
                  <span className="font-semibold text-white text-right">1,433 sqm / 15,424.67 sqft</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Total Units:</span>
                  <span className="font-semibold text-white text-right">34 Residential</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                ...
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  ...
                  <span className="font-semibold text-white text-right">1 to 5-Bedroom</span>
                </div>
          ...
          <div className={`text-center mb-4 transition-all duration-1000 delay-500 ${
            ...
            <div className="bg-gradient-to-r from-[#ce001f] to-[#b3001a] text-white rounded-2xl p-8 max-w-4xl mx-auto hover:shadow-2xl transition-all duration-500 hover:scale-105">
              ...
              <p className="text-lg mb-6 opacity-90">
                Register now for an exclusive preview of Artisan 8 
              </p>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="font-semibold text-white">Address</p>
                      <p className="text-sm text-gray-300 font-light">8 Sin Ming Road</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
      ...
      <section
        ...
        style={{ 
          backgroundImage: "url('/images/artisan8/artisan8-hero-background.webp')",
