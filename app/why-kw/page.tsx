        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              ...
              <h2 className="text-3xl font-bold mb-4 text-white">Cutting-Edge Technology</h2>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-primary-red mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-lg text-white">Command Center</h3>
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-primary-red mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-lg text-white">KW Mobile App</h3>
                    <p className="text-gray-300">Manage your business on the go with our powerful mobile application</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-primary-red mr-3 flex-shrink-0" />
            ...
            <div className="md:w-1/2 order-1 md:order-2">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-primary-red mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-lg text-white">KW MAPS Coaching</h3>
                    <p className="text-gray-300">One-on-one coaching with industry experts to accelerate your growth</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-primary-red mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-lg text-white">New Launch Masterclass</h3>
                    <p className="text-gray-300">
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-primary-red mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-lg text-white">Continuous Education</h3>
                    <p className="text-gray-300">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              ...
              <h2 className="text-3xl font-bold mb-4 text-white">Unique Growth Share Model</h2>
              <p className="text-lg text-gray-300 mb-6">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-primary-red mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-lg text-white">Competitive Commission Splits</h3>
                    <p className="text-gray-300">Industry-leading commission structure that rewards performance</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-primary-red mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-lg text-white">Profit Share</h3>
                    <p className="text-gray-300">
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-primary-red mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-lg text-white">Wealth Building Opportunities</h3>
                    <p className="text-gray-300">
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-block bg-primary-red/10 px-4 py-2 rounded-full text-primary-red font-medium mb-4">MVVBP</div>
            <h2 className="text-3xl font-bold mb-4 text-white">Our Mission, Vision, Values, Beliefs & Perspective</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-700">
              ...
              <p className="text-gray-300 text-center">
                Integrity, excellence, and innovation guide everything we do, from training to client service.
              </p>
            </div>
          </div>
        </div>
