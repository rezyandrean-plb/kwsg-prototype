    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
          <div className="container mx-auto px-4 pb-16">
            ...
            <div className="max-w-xl bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden flex p-1">
              <Input
                type="text"
                placeholder="Search articles, trends, and insights..."
                className="flex-1 border-0 bg-transparent text-white placeholder:text-white/60 focus-visible:ring-0"
              />
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              ...
              <h2 className="text-3xl font-bold mb-4">The Future of New Launch Properties in a Post-Pandemic World</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 mb-12">Stay updated with the newest insights and trends in real estate</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">5 Luxury Condominium Trends to Watch in 2024</h3>
                ...
                <Link href="#" className="text-primary font-medium hover:underline text-sm inline-flex items-center">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Investment Strategies for New Launch Properties</h3>
                <p className="text-gray-600 mb-4 line-clamp-3">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">The Rise of Sustainable New Developments</h3>
                <p className="text-gray-600 mb-4 line-clamp-3">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 mb-12">Data-driven analysis to help you make informed decisions</p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md border border-gray-100">
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-xl font-bold mb-1">Q1 2024 New Launch Market Report</h3>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md border border-gray-100">
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-xl font-bold mb-1">New Launch Price Index</h3>
                    <p className="text-gray-500 text-sm">
                      Track price movements across different regions and property types
                    </p>
                  </div>
                  <div className="bg-primary/10 p-2 rounded-full">
                    <svg
