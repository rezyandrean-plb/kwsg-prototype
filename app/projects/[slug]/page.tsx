...
export default function ProjectPage({ params }: ProjectPageProps) {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-[#1c1c1d] text-white">
          ...
          <div className="md:w-1/3 flex flex-col gap-4">
            <div className="bg-[#242728] text-white rounded-lg p-6 shadow-lg flex flex-col gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-auto text-xs text-gray-400">Ref: {unwrappedParams.slug}</span>
              </div>
              ...
              <div className="flex flex-wrap gap-3 text-gray-300 text-sm">
                <div className="flex items-center"><Building2 className="h-4 w-4 mr-1 text-red-500" />{project.developer}</div>
                <div className="flex items-center"><Calendar className="h-4 w-4 mr-1 text-red-500" />Est. {project.completion}</div>
                <div className="flex items-center"><Home className="h-4 w-4 mr-1 text-red-500" />{project.totalUnits}</div>
                <div className="flex items-center"><DollarSign className="h-4 w-4 mr-1 text-red-500" /><span className="text-red-500">{project.price}</span></div>
              </div>
            ...
            {/* Key Facts Card */}
            <div className="bg-[#242728] border border-gray-800 rounded-lg p-4 grid grid-cols-2 gap-4 text-sm">
              <div>
      ...
      {/* Facilities Section */}
      <section className="bg-[#242728] py-10">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold mb-6 text-white">Facilities</h2>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a
          ...
          className="flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#128C7E] transition-all duration-300 hover:scale-110"
