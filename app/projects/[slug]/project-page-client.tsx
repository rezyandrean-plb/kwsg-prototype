...
// Temporarily use placeholder components until the real ones are created
const MoatRadarChart = ({ moat }: MoatRadarChartProps) => (
  <div className="w-full h-[400px] bg-gray-800 rounded-lg flex items-center justify-center">
    <p className="text-gray-400">Moat Radar Chart Component (Coming Soon)</p>
  </div>
)

const NearbyAmenitiesMap = ({ project }: NearbyAmenitiesMapProps) => (
  <div className="w-full h-full bg-gray-800 rounded-lg flex items-center justify-center">
    <p className="text-gray-400">Nearby Amenities Map Component (Coming Soon)</p>
  </div>
)
                ...
                <div className="bg-[#242728] border border-gray-700 rounded-lg p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <table className="w-full">
                        <tbody>
                          {project.unitTypes.map((unit: UnitType, idx: number) => (
