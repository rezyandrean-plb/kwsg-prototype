...
export default function NewLaunchDirectory() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/new-launch-notification', {
        method: 'POST',
        headers: {
      ...
      if (response.ok && result.success) {
        setSubmitMessage("Thank you! Your notification request has been submitted successfully. We'll notify you when our new launch directory goes live.")
              ...
              <Dialog open={isOpen} onOpenChange={setIsOpen}>
                ...
                <DialogContent className="sm:max-w-[600px] bg-white border-gray-200">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 mt-4">
                    ...
                    >
                      {isSubmitting ? "Submitting..." : "Notify Me First"}
