...
export default function ProjectsPage() {
  return (
    <main className="min-h-screen flex flex-col">
      <section className="bg-primary text-white h-screen flex items-center">
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="container mx-auto px-4 text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">New Launch Projects</h1>
              <p className="text-xl max-w-3xl mx-auto mb-12">
                Discover the most exclusive new property launches in prime locations
              </p>
              <div className="max-w-3xl mx-auto bg-white rounded-lg overflow-hidden flex">
                <Input
                  type="text"
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              ...
              <p className="text-gray-600">Showing 12 new launch projects</p>
            </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Why Choose Us for New Launches?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Get priority access to new launches before they hit the market</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Our specialists have in-depth knowledge of every new launch project</p>
            </div>
