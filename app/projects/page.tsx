...
const fetchProjects = async (): Promise<Project[]> => {
  try {
    ...
    return apiProjects.map((apiProject): Project => {
      ...
      // Generate image URL - use image_url_banner if available, otherwise use local fallback
      const image = apiProject.image_url_banner && apiProject.image_url_banner.trim() !== '' 
      ...
      return {
        ...
        image,
        image_url_banner: apiProject.image_url_banner,
