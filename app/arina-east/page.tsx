          ...
          <div className={`max-w-4xl transition-all duration-1000 delay-300 ${
            ...
            <div className={`mb-4 sm:mb-2 md:mb-2 lg:mb-6 transition-all duration-700 delay-700 ${
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white mb-2 sm:mb-2 md:mb-2 lg:mb-4 leading-tight">
                <span className={`transition-all duration-1000 delay-900 ${isVisible ? 'animate-fade-in-left' : ''}`}>ARINA EAST
                </span>
                <br />
                <span className={`text-4xl md:text-6xl font-light text-white/90 transition-all duration-1000 delay-1100 ${isVisible ? 'animate-fade-in-right' : ''}`}>RESIDENCES</span>
              </h1>
      ...
      >
        <div className="container mx-auto px-4">
          <div className={`text-center mb-12 transition-all duration-1000 delay-300 ${
            ...
            Arina East Residences is the latest freehold landmark by <b>ZACD Group</b>, <b>Fraxtor Singapore</b>, and <b>Welltech Pte Ltd</b>, located along the coveted <b>Marina East precinct</b> in <b>District 15</b>. 
            Just a 3-minute walk to <b>Katong Park MRT (TEL)</b> and minutes from <b>Marina Bay</b>, it blends city connectivity with coastal tranquillity.
            </p>
            <p className="text-sm md:text-xl text-gray-300 max-w-4xl mx-auto">
            This exclusive twin-tower development offers a collection of 1- to 4-bedroom homes, each corner-facing and meticulously designed by <b>Design Intervention</b> / <b>Ong & Ong Pte Ltd</b>. 
            <b>With 270° panoramic views, sky terraces, and resort-style facilities</b>, Arina East Residences defines a new benchmark for <b>Marina East luxury living</b>—where the heart of the city meets the soul of the beach.
            </p>
          </div>
