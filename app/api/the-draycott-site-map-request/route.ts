...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('The Draycott Site Map & Floor Plan request form submission received:', { 
      fullName, 
      emailAddress, 
      contactNumber,
    ...
    return NextResponse.json({
      success: true,
      message: 'Thank you for your interest in The Draycott! We have sent you a confirmation email and our team will contact you soon with the site map & floor plan.',
      notificationSent: notificationResult.success,
      autoReplySent: autoReplyResult.success
    })

  } catch (error) {
    console.error('The Draycott Site Map & Floor Plan request form error:', error)
    return NextResponse.json(
...
async function sendNotificationEmail({ 
  ...
  try {
    ...
    const toEmails = [
      process.env.THE_DRAYCOTT_LEAD_TO_EMAIL || 'consults@propertylimbrothers.com'
    ]
    
    console.log('Notification email configuration (The Draycott Site Map):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
      toEmails
    ...
    const emailContent = {
      ...
      subject: `New Site Map & Floor Plan Request - The Draycott - ${fullName}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #ce001f; color: white; padding: 20px; text-align: center;">
            ...
            <p style="margin: 5px 0 0 0; font-size: 16px;">Site Map & Floor Plan Request - The Draycott</p>
          </div>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 0;">
                ...
                <strong>Project:</strong> The Draycott<br>
                <strong>Address:</strong> 50 Draycott Park, Singapore 259396<br>
                <strong>District:</strong> 10 - Tanglin / Holland / Bukit Timah<br>
                <strong>Developer:</strong> Tan Chwee Boon Pte Ltd<br>
                <strong>Tenure:</strong> Freehold
              </p>
            </div>
...
async function sendAutoReplyEmail({ fullName, emailAddress }: {
  ...
  try {
    ...
    console.log('Auto-reply email configuration (The Draycott Site Map):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
    ...
    const emailContent = {
      to: emailAddress,
      from: fromEmail,
      subject: `The Draycott Site Map & Floor Plan Request Confirmation - KW Singapore`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #ce001f; color: white; padding: 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">KW Singapore</h1>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 10px 0 0 0;">
                Thank you for your interest in The Draycott! We have received your request for the site map & floor plan, and our team will contact you within 24 business hours to provide you with the detailed materials and additional project information.
              </p>
            </div>
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              <h3 style="color: #ce001f; margin-top: 0;">About The Draycott</h3>
              <ul style="color: #666; line-height: 1.6; margin: 0; padding-left: 20px;">
                <li>Prime District 10 location - Tanglin / Holland / Bukit Timah</li>
                <li>Freehold tenure in a blue-chip District 10 enclave</li>
                <li>Located within the Ardmore–Draycott luxury belt, just off Orchard Road</li>
                <li>Quiet residential setting with limited through traffic</li>
                <li>Predominantly 2,600+ sqft homes designed for spacious living</li>
                <li>Single-unit-per-floor tower homes for enhanced privacy</li>
                <li>Low-density development with only 132 units across an expansive site</li>
                <li>Close proximity to Orchard shopping belt, Tanglin Club, and premier amenities</li>
              </ul>
            </div>
