...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Arina East Site Map & Floor Plan request form submission received:', { 
      fullName, 
      emailAddress, 
      contactNumber,
    ...
    */
    ...
    return NextResponse.json({
      success: true,
      message: 'Thank you for your interest in Arina East! We have sent you a confirmation email and our team will contact you soon with the site map & floor plan.',
    ...
    console.error('Arina East Site Map & Floor Plan request form error:', error)
    return NextResponse.json(
...
async function sendNotificationEmail({ 
  ...
  try {
    ...
    const toEmails = [
      process.env.ARINA_EAST_LEAD_TO_EMAIL || 'consults@propertylimbrothers.com'
    ]
    
    console.log('Notification email configuration (Arina East Site Map):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
      toEmails
    ...
    const emailContent = {
      ...
      subject: `New Site Map & Floor Plan Request - Arina East - ${fullName}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #B40101; color: white; padding: 20px; text-align: center;">
            ...
            <p style="margin: 5px 0 0 0; font-size: 16px;">Site Map & Floor Plan Request - Arina East</p>
          </div>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 0;">
                <strong>Project:</strong> Arina East<br>
                <strong>District:</strong> District 15 (Marina East)<br>
                <strong>Location:</strong> 6C & 6D Tanjong Rhu Road, Singapore<br>
                <strong>Developer:</strong> ZACD LV Development Pte. Ltd.<br>
                <strong>Request Type:</strong> Site Map & Floor Plan
              </p>
            </div>
...
async function sendAutoReplyEmail({ fullName, emailAddress }: {
  ...
  try {
    ...
    console.log('Auto-reply email configuration (Arina East Site Map):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
    ...
    const emailContent = {
      to: emailAddress,
      from: fromEmail,
      subject: `Arina East Site Map & Floor Plan Request Confirmation - KW Singapore`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #B40101; color: white; padding: 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">KW Singapore</h1>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 10px 0 0 0;">
                Thank you for your interest in Arina East! We have received your request for the site map & floor plan, and our team will contact you within 24 business hours to provide you with the detailed materials and additional project information.
              </p>
            </div>
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              <h3 style="color: #B40101; margin-top: 0;">About Arina East</h3>
              <ul style="color: #666; line-height: 1.6; margin: 0; padding-left: 20px;">
                <li>District 15, Marina East - Prime location at Tanjong Rhu Road</li>
                <li>Developed by ZACD LV Development Pte. Ltd.</li>
                <li>Premium residential development with modern amenities</li>
                <li>Strategic location near East Coast Park and amenities</li>
                <li>Excellent investment potential in District 15</li>
              </ul>
            </div>
...
async function insertIntoGoogleSheets({ 
  ...
  try {
    // Match Arina East Lead Form spreadsheet config
    const rawSpreadsheetEnv = process.env.GOOGLE_SHEETS_ARINA_EAST_LEAD_SPREADSHEET_ID
    ...
    const targetRange = process.env.GOOGLE_SHEETS_ARINA_EAST_LEAD_RANGE || 'SiteMapRequests!A:F'
    
    console.log('Google Sheets configuration (Arina East Site Map & Floor Plan):', {
    ...
    console.log('📊 Attempting to insert data into Google Sheets (Arina East Site Map & Floor Plan)...')
    ...
    // Prepare data row to match Arina East Lead Form columns (A:F)
    ...
    console.log('✅ Data inserted into Google Sheets successfully (Arina East Site Map & Floor Plan)')
