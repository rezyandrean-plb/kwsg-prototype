...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Aurea + The Golden Mile Lead Generation form submission received:', { 
      fullName, 
      contactNumber, 
      emailAddress, 
      preferredDate, 
    ...
    */
    ...
    return NextResponse.json({
      success: true,
      message: 'Thank you for your interest in Aurea + The Golden Mile! We have sent you a confirmation email and our team will contact you soon to arrange your showflat visit.',
    ...
    console.error('Aurea + The Golden Mile Lead Generation form error:', error)
    return NextResponse.json(
...
async function sendNotificationEmail({ 
  ...
  try {
    ...
    const toEmails = [
      process.env.AUREA_THE_GOLDEN_MILE_LEAD_TO_EMAIL || 'consults@propertylimbrothers.com'
    ]
    
    console.log('Notification email configuration (Aurea + The Golden Mile Lead):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
      toEmails
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #B40101; color: white; padding: 20px; text-align: center;">
            ...
            <p style="margin: 5px 0 0 0; font-size: 16px;">Aurea + The Golden Mile Lead Generation</p>
          </div>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #333;">${projectType || 'Not specified'}</td>
                </tr>
                <tr>
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 0;">
                <strong>Project:</strong> Aurea + The Golden Mile<br>
                <strong>District:</strong> District 7 (Beach Road)<br>
                <strong>Location:</strong> 800 Beach Road, Singapore 199979 / 802 Beach Road, Singapore 199980<br>
                <strong>Developer:</strong> Far East Organization and Perennial Holdings<br>
...
async function sendAutoReplyEmail({ fullName, emailAddress, projectType }: {
  ...
  try {
    ...
    console.log('Auto-reply email configuration (Aurea + The Golden Mile Lead):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
    ...
    const projectTypeText = projectType ? ` for ${projectType}` : ''

    const emailContent = {
      to: emailAddress,
      from: fromEmail,
      subject: `Aurea + The Golden Mile Showflat Visit Request Confirmation - KW Singapore`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #B40101; color: white; padding: 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">KW Singapore</h1>
            <p style="margin: 5px 0 0 0; font-size: 16px;">Aurea + The Golden Mile Showflat Visit</p>
          </div>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 10px 0 0 0;">
                Thank you for your interest in Aurea + The Golden Mile${projectTypeText}! We have received your showflat visit request and our team will contact you within 24 business hours to arrange your visit.
              </p>
            </div>
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              <h3 style="color: #B40101; margin-top: 0;">About Aurea + The Golden Mile</h3>
              <ul style="color: #666; line-height: 1.6; margin: 0; padding-left: 20px;">
                <li>District 7, Beach Road - Prime location in the heart of Singapore</li>
                <li>Developed by Far East Organization and Perennial Holdings</li>
                <li>Two distinct yet connected components: Aurea (residential) and The Golden Mile (commercial)</li>
                <li>Breathing new life into the renowned Golden Mile Complex national monument</li>
                <li>Strategic location near Nicoll Highway MRT and Lavender MRT</li>
                <li>Excellent connectivity to major expressways (ECP, KPE, Nicoll Highway)</li>
...
// Google Sheets integration - DISABLED FOR NOW
// TODO: Enable when Google Sheets spreadsheet is set up
/*
async function insertIntoGoogleSheets({ 
  ...
  try {
    ...
    const rawSpreadsheetEnv = process.env.GOOGLE_SHEETS_AUREA_THE_GOLDEN_MILE_LEAD_SPREADSHEET_ID
    ...
    const targetRange = process.env.GOOGLE_SHEETS_AUREA_THE_GOLDEN_MILE_LEAD_RANGE || 'ShowflatVisitRequests!A:J'

    console.log('Google Sheets configuration (Aurea + The Golden Mile Lead):', {
    ...
    const dataRow = [
      ...
      '800 Beach Road, Singapore 199979 / 802 Beach Road, Singapore 199980, District 7 (Beach Road)',
      'Far East Organization and Perennial Holdings',
      preferredDate ? new Date(preferredDate).toLocaleDateString('en-SG') : '',
      preferredTiming || '',
      'Aurea + The Golden Mile Lead Generation'
    ]
    ...
    try {
      ...
      if (appendError instanceof Error && appendError.message.includes('protected cell or object')) {
        ...
        const range = `${baseTab}!A${nextRow}:K${nextRow}`
    ...
    console.log('✅ Data inserted into Google Sheets successfully (Aurea + The Golden Mile Lead)')
