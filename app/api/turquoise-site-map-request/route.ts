...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Turquoise Site Map & Floor Plan request form submission received:', { 
      fullName, 
      emailAddress, 
      contactNumber,
    ...
    return NextResponse.json({
      success: true,
      message: 'Thank you for your interest in Turquoise! We have sent you a confirmation email and our team will contact you soon with the site map & floor plan.',
      notificationSent: notificationResult.success,
      autoReplySent: autoReplyResult.success
    })

  } catch (error) {
    console.error('Turquoise Site Map & Floor Plan request form error:', error)
    return NextResponse.json(
...
async function sendNotificationEmail({ 
  ...
  try {
    ...
    const toEmails = [
      process.env.TURQUOISE_LEAD_TO_EMAIL || 'consults@propertylimbrothers.com'
    ]
    
    console.log('Notification email configuration (Turquoise Site Map):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
      toEmails
    ...
    const emailContent = {
      ...
      subject: `New Site Map & Floor Plan Request - Turquoise - ${fullName}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #B40101; color: white; padding: 20px; text-align: center;">
            ...
            <p style="margin: 5px 0 0 0; font-size: 16px;">Site Map & Floor Plan Request - Turquoise</p>
          </div>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 0;">
                ...
                <strong>Project:</strong> Turquoise<br>
                <strong>Address:</strong> 51 Cove Drive, Singapore 098393<br>
                <strong>District:</strong> D04 - Sentosa / Harbourfront<br>
                <strong>Developer:</strong> Ho Bee Cove Pte Ltd
              </p>
            </div>
...
async function sendAutoReplyEmail({ fullName, emailAddress }: {
  ...
  try {
    ...
    console.log('Auto-reply email configuration (Turquoise Site Map):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
    ...
    const emailContent = {
      to: emailAddress,
      from: fromEmail,
      subject: `Turquoise Site Map & Floor Plan Request Confirmation - KW Singapore`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #B40101; color: white; padding: 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">KW Singapore</h1>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 10px 0 0 0;">
                Thank you for your interest in Turquoise! We have received your request for the site map & floor plan, and our team will contact you within 24 business hours to provide you with the detailed materials and additional project information.
              </p>
            </div>
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              <h3 style="color: #B40101; margin-top: 0;">About Turquoise</h3>
              <ul style="color: #666; line-height: 1.6; margin: 0; padding-left: 20px;">
                <li>D04 - Sentosa / Harbourfront - Prime location at Cove Drive, Sentosa Cove</li>
                <li>Developed by Ho Bee Cove Pte Ltd</li>
                <li>Rare waterway-front residence with unblocked waterway views</li>
                <li>Immediate access to ONE°15 Marina</li>
                <li>Ultra-spacious large-format layouts</li>
                <li>Luxury interior finishes with Miele kitchenware</li>
              </ul>
            </div>
