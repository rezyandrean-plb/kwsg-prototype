...
async function sendNotificationEmail({ 
  ...
  try {
    ...
    const toEmail = process.env.PENRITH_EVENT_TO_EMAIL || 'cynthia.loh@propertylimbrothers.com'
...
async function sendAutoReplyEmail({ fullName, emailAddress }: {
  ...
  try {
    ...
    const emailContent = {
      to: emailAddress,
      from: fromEmail,
      subject: 'Penrith Live Seminar - Your Seat is Confirmed!',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #B40101; color: white; padding: 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">KW Singapore</h1>
            <p style="margin: 5px 0 0 0; font-size: 16px;">Penrith Live Seminar</p>
          </div>
          <div style="padding: 30px; background-color: #f9f9f9;">
            <div style="background-color: white; padding: 25px; border-radius: 8px; margin-bottom: 20px;">
              <p style="color: #333; line-height: 1.6; margin: 0 0 15px 0; font-size: 16px;">Hi ${fullName},</p>
              <p style="color: #333; line-height: 1.6; margin: 0 0 15px 0; font-size: 16px;">Thanks for signing up for the Penrith Live Seminar! Your seat is confirmed.</p>
            </div>
            <div style="background-color: white; padding: 25px; border-radius: 8px; margin-bottom: 20px;">
              <div style="margin-bottom: 15px; display: flex; align-items: flex-start;">
                ...
                <div style="flex: 1;">
                  ...
                  <span style="color: #333; margin-left: 10px;">Penrith Showflat - 6A Margaret Dr, Singapore 142006</span>
                </div>
              </div>
            </div>
            <div style="background-color: white; padding: 25px; border-radius: 8px; margin-bottom: 20px;">
              <p style="color: #333; line-height: 1.6; margin: 0 0 10px 0;">See you soon,</p>
              <p style="color: #B40101; font-weight: bold; margin: 0;">KW Singapore</p>
            </div>
          </div>
          <div style="background-color: #333; color: white; padding: 20px; text-align: center; font-size: 12px;">
            <p style="margin: 0;">© 2025 KW Singapore. All rights reserved.</p>
