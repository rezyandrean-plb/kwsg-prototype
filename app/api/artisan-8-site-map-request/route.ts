...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Artisan 8 Site Map & Floor Plan request form submission received:', { 
      fullName, 
      emailAddress, 
      contactNumber,
    ...
    return NextResponse.json({
      success: true,
      message: 'Thank you for your interest in Artisan 8! We have sent you a confirmation email and our team will contact you soon with the site map & floor plan.',
    ...
    console.error('Artisan 8 Site Map & Floor Plan request form error:', error)
    return NextResponse.json(
...
async function sendNotificationEmail({ 
  ...
  try {
    ...
    const toEmails = [
      process.env.ARTISAN_8_LEAD_TO_EMAIL || 'consults@propertylimbrothers.com'
    ]
    
    console.log('Notification email configuration (Artisan 8 Site Map):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
      toEmails
    ...
    const emailContent = {
      ...
      subject: `New Site Map & Floor Plan Request - Artisan 8 - ${fullName}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #B40101; color: white; padding: 20px; text-align: center;">
            ...
            <p style="margin: 5px 0 0 0; font-size: 16px;">Site Map & Floor Plan Request - Artisan 8</p>
          </div>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 0;">
                <strong>Project:</strong> Artisan 8<br>
                <strong>District:</strong> District 20 (Ang Mo Kio / Bishan / Thomson)<br>
                <strong>Location:</strong> 8 Sin Ming Road, Singapore 575628<br>
                <strong>Developer:</strong> Apex Asia (2) Pte Ltd<br>
...
async function sendAutoReplyEmail({ fullName, emailAddress }: {
  ...
  try {
    ...
    console.log('Auto-reply email configuration (Artisan 8 Site Map):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
    ...
    const emailContent = {
      to: emailAddress,
      from: fromEmail,
      subject: `Artisan 8 Site Map & Floor Plan Request Confirmation - KW Singapore`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #B40101; color: white; padding: 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">KW Singapore</h1>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 10px 0 0 0;">
                Thank you for your interest in Artisan 8! We have received your request for the site map & floor plan, and our team will contact you within 24 business hours to provide you with the detailed materials and additional project information.
              </p>
            </div>
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              <h3 style="color: #B40101; margin-top: 0;">About Artisan 8</h3>
              <ul style="color: #666; line-height: 1.6; margin: 0; padding-left: 20px;">
                <li>District 20, Ang Mo Kio / Bishan / Thomson - Prime location at 8 Sin Ming Road</li>
                <li>Developed by Apex Asia (2) Pte Ltd</li>
                <li>Freehold waterfront residence</li>
                <li>Strategic location near Upper Thomson MRT and nature reserves</li>
                <li>Excellent investment potential in District 20</li>
              </ul>
            </div>
