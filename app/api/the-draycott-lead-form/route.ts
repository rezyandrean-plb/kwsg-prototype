...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('The Draycott Lead Generation form submission received:', { 
      fullName, 
      contactNumber, 
      emailAddress, 
      preferredDate, 
    ...
    return NextResponse.json({
      success: true,
      message: 'Thank you for your interest in The Draycott! We have sent you a confirmation email and our team will contact you soon to arrange your showflat visit.',
      notificationSent: notificationResult.success,
      autoReplySent: autoReplyResult?.success || false
    })

  } catch (error) {
    console.error('The Draycott Lead Generation form error:', error)
    return NextResponse.json(
...
async function sendNotificationEmail({ 
  ...
  try {
    ...
    console.log('Notification email configuration (The Draycott Lead):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
      toEmails
    ...
    const emailContent = {
      ...
      subject: `New The Draycott Showflat Visit Request - ${fullName}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #ce001f; color: white; padding: 20px; text-align: center;">
            ...
            <p style="margin: 5px 0 0 0; font-size: 16px;">The Draycott Showflat Visit Request</p>
          </div>
...
async function sendAutoReplyEmail({ fullName, emailAddress }: {
  ...
  try {
    ...
    console.log('Auto-reply email configuration (The Draycott Lead):', {
      isDevelopment,
      hasApiKey: !!apiKey,
      fromEmail,
    ...
    const emailContent = {
      to: emailAddress,
      from: fromEmail,
      subject: `The Draycott Showflat Visit Request Confirmation - KW Singapore`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #ce001f; color: white; padding: 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">KW Singapore</h1>
            <p style="margin: 5px 0 0 0; font-size: 16px;">The Draycott Showflat Visit</p>
          </div>
          ...
          <div style="padding: 30px; background-color: #f9f9f9;">
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; line-height: 1.6; margin: 10px 0 0 0;">
                Thank you for your interest in The Draycott! We have received your showflat visit request and our team will contact you within 24 business hours to arrange your visit.
              </p>
            </div>
