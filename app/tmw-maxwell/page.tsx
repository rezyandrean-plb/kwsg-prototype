  ...
  return (
    <Card className={`bg-white/20 backdrop-blur-sm text-white p-6 md:p-12 shadow-2xl border-0 rounded-xl hover:shadow-3xl transition-all duration-700 hover:scale-105`}>
      ...
      <p className="text-md mb-8 opacity-90 text-white text-center">
        Be the first to own a home that combines convenience, luxury, and nature. Register now for an exclusive preview of TMW Maxwell .
      </p>
      {submitError && (
...
export default function WResidenceLanding() {
  ...
  useEffect(() => {
    // Set page title
    document.title = 'TMW Maxwell - KW Singapore'
  ...
  // Site Plan images for carousel (replace with TMW Maxwell assets when ready)
  const sitePlanImages: string[] = [
    "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/site-plan/tmw-siteplan-1.webp",
    "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/site-plan/tmw-siteplan-2.webp",
    "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/site-plan/tmw-siteplan-3.webp",
  ]

  useEffect(() => {
    setProjectImages([
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/1.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/2.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/3.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/4.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/5.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/6.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/7.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/8.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/9.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/10.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/11.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/12.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/13.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/14.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/15.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/16.webp",
      "https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/gallery/17.webp",
    ])
  }, [])

  // Auto-slide for Gallery
  useEffect(() => {
    if (isGalleryPaused || projectImages.length === 0) return
  ...
  }, [isGalleryPaused, projectImages.length])
  ...
  const mockUnitPricing = [
    ...
    },
    {
      ...
      subtypes: [
        {
          subtype: "1-Bedroom + Study",
          bedrooms: 1,
          bathrooms: 1,
          size: "549 - 570 sqft",
          price: "Start from $1,586,000",
          currency: "SGD",
          total: 34,
          available: 34,
          status: 34,
    ...
    },
    {
      ...
      subtypes: [
        {
          subtype: "1-Bedroom Loft",
          bedrooms: 1,
          bathrooms: 1,
          size: "850 - 883 sqft",
          price: "Start from $2,257,000",
          currency: "SGD",
          total: 5,
          available: 5,
          status: 5,
    ...
    {
      unitType: "1-Bedroom Suite",
      subtypes: [
        {
          subtype: "1-Bedroom Suite",
          bedrooms: 1,
          bathrooms: 1,
          size: "517 sqft",
          price: "Start from $1,502,000",
          currency: "SGD",
          total: 34,
          available: 33,
          status: 33,
    ...
    },
    {
      ...
      subtypes: [
        {
          subtype: "2-Bedroom Dual Key",
          bedrooms: 2,
          bathrooms: 2,
          size: "861 - 872 sqft",
          price: "Start from $2,440,000",
          currency: "SGD",
          total: 34,
          available: 34,
          status: 34,
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        toast({
          ...
          description: "Thank you for your interest in TMW Maxwell ! We have sent you a confirmation email and our team will contact you soon to arrange your showflat visit.",
          variant: "default",
        })
    ...
    >
      ...
      <section className="relative min-h-screen md:min-h-0 md:h-[50vh] lg:min-h-screen lg:h-auto flex items-center justify-center">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/new-launch-collection/mega-landing-page/tmw-maxwell/tmw-maxwell-hero.webp"
            alt="TMW Maxwell Hero"
            fill
          ...
          <div className={`max-w-4xl transition-all duration-1000 delay-300 ${
            ...
            <div className={`mb-4 sm:mb-2 md:mb-2 lg:mb-6 transition-all duration-700 delay-700 ${
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white mb-2 sm:mb-2 md:mb-2 lg:mb-4 leading-tight">
                <span className={`transition-all duration-1000 delay-900 ${isVisible ? 'animate-fade-in-left' : ''}`}>TMW MAXWELL
                </span>
              </h1>
              ...
              <div className={`flex items-center mb-2 sm:mb-2 md:mb-2 lg:mb-4 transition-all duration-700 delay-1300 ${
                ...
                <p className="text-lg text-gray-200 font-light">D2 – Chinatown, Tanjong Pagar</p>
              </div>
        ...
        <div className={`absolute bottom-2 right-2 sm:bottom-4 sm:right-4 transition-all duration-1000 delay-2000 ${
          ...
          <p className="text-[9px] sm:text-xs text-white/70 bg-black/30 backdrop-blur-sm px-2 py-1 sm:px-3 sm:py-2 rounded-lg whitespace-nowrap">
            Images are for illustrative purposes only and may <br className="sm:hidden"/> not reflect the final design of TMW Maxwell.
          </p>
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-4">
          <div className={`text-center mb-12 transition-all duration-1000 delay-300 ${
            ...
            <h2 className="text-3xl font-light mb-3 text-white text-center tracking-wide">TMW Maxwell</h2>
          ...
          {/* <div className="flex flex-wrap gap-6 lg:gap-4 mb-12 justify-center">
            {[
              ...
              { icon: <BedDouble className="w-12 h-12 mx-auto mb-4" style={{ color: '#ce001f' }} />, desc: "Studio, 1 To 2-Bedroom Units with Full Condo Facilities" },
              { icon: <Layers className="w-12 h-12 mx-auto mb-4" style={{ color: '#ce001f' }} />, desc: "99-Year Leasehold from April 2023 in Marina Bay, Singapore’s Global Financial Hub" },
              { icon: <Building className="w-12 h-12 mx-auto mb-4" style={{ color: '#ce001f' }} />, desc: "Jointly developed by SingHaiyi Group and Chuan Investments" }
            ].map((card, index) => (
              <Card 
                key={index} 
            ...
            <Card className="lg:col-span-4 border-gray-700 bg-[#18191b] hover:shadow-lg transition-all duration-500">
              ...
              <CardContent className="space-y-6">
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  ...
                  <span className="font-semibold text-white text-right">TMW Maxwell</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Developer:</span>
                  <span className="font-semibold text-white text-right">JV between SingHaiyi Group and Chuan Investments</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Tenure:</span>
                  <span className="font-semibold text-white text-right">99 Years from April 2023</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">District:</span>
                  <span className="font-semibold text-white text-right sm:text-left">D2 – Chinatown, Tanjong Pagar</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Address:</span>
                  <span className="font-semibold text-white text-right">31 Tras Street, Singapore, 079934</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Site Area:</span>
                  <span className="font-semibold text-white text-right">21, 746.48 sqm / 41,799 sqft</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Blocks:</span>
                  <span className="font-semibold text-white text-right sm:text-left">1</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                ...
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  ...
                  <span className="font-semibold text-white">324 Residential + 11 Commercial</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Unit Mix:</span>
                  <span className="font-semibold text-white text-right">Studio, 1 To 2-Bedrooms</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Architect:</span>
                  <span className="font-semibold text-white text-right">Formwerks Architects</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">Landscape:</span>
                  <span className="font-semibold text-white text-right">Compound Collaborative Pte Ltd</span>
                </div>
                <div className="flex justify-between border-b border-gray-500 pb-3">
                  <span className="font-medium text-gray-300">TOP:</span>
                  <span className="font-semibold text-right">June 2028</span>
                </div>
              </CardContent>
            </Card>
                          ...
                          {sitePlanImages.map((image, index) => (
                            <CarouselItem key={index}>
                              <div className="relative">
                                 <Image
                                   src={image}
                                   alt={`TMW Maxwell Site Plan ${index + 1}`}
                                  width={800}
                                  height={500}
                                  quality={90}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
                ...
                <div className="rounded-xl border border-gray-700 bg-[#1c1c1d] shadow-xl overflow-hidden">
                  <div className="px-6 py-4 bg-black/20">
                    <h3 className="text-xl font-semibold text-white">Roof</h3>
                  </div>
                ...
                {/* Card 2 - 15th - 20th Storey */}
                <div className="rounded-xl border border-gray-700 bg-[#1c1c1d] shadow-xl overflow-hidden">
                  <div className="px-6 py-4 bg-black/20">
                    <h3 className="text-xl font-semibold text-white">15th - 20th Storey</h3>
                  </div>
                  <div className="px-6 py-6">
                    <ul className="list-disc list-inside space-y-2 text-gray-300">
                      <li>Sky Pool</li>
                ...
                {/* Card 3 - 11th - 13th Storey */}
                <div className="rounded-xl border border-gray-700 bg-[#1c1c1d] shadow-xl overflow-hidden">
                  <div className="px-6 py-4 bg-black/20">
                    <h3 className="text-xl font-semibold text-white">11th - 13th Storey</h3>
                  </div>
                  <div className="px-6 py-6">
                    <ul className="list-disc list-inside space-y-2 text-gray-300">
                      <li>Do-It-All Deck</li>
                      <li>Executive Lounge</li>
                      <li>Social Garden</li>
                      <li>TMW Social Club</li>
                      <li>Social Lounge</li>
                      <li>Social Blooms</li>
                      <li>The Bar Lounge</li>
                      <li>Plug and Work</li>
                    </ul>
                  </div>
                </div>

                {/* Card 4 - 4th - 10th Storey */}
                <div className="rounded-xl border border-gray-700 bg-[#1c1c1d] shadow-xl overflow-hidden">
                  <div className="px-6 py-4 bg-black/20">
                    <h3 className="text-xl font-semibold text-white">4th - 10th Storey</h3>
                  </div>
                  <div className="px-6 py-6">
                    <ul className="list-disc list-inside space-y-2 text-gray-300">
                      <li>The Courtyard</li>
                      <li>Courtyard Dining</li>
                      <li>Fitness Courtyard</li>
                      <li>Festival Lawn</li>
                      <li>Courtyard Garden</li>
                      <li>Courtyard Lounge</li>
                      <li>Farm-to-Fork Garden</li>
                      <li>TMW Study</li>
                      <li>Reading Alcove</li>
                      <li>Working Lounge</li>
                      <li>Outdoor Living Room</li>
                      <li>Breakout Pod</li>
            ...
            >
              <div className="relative h-[500px] rounded-xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt={`TMW Maxwell - Image ${currentImageIndex + 1}`}
                  fill
                  className={`object-cover transition-opacity duration-700 ease-in-out ${
                    galleryFade ? 'opacity-0' : 'opacity-100'
                  }`}
                />
          ...
          <div className={`text-center mb-4 transition-all duration-1000 delay-500 ${
            ...
            <div className="bg-gradient-to-r from-[#ce001f] to-[#b3001a] text-white rounded-2xl p-8 max-w-4xl mx-auto hover:shadow-2xl transition-all duration-500 hover:scale-105">
              ...
              <p className="text-lg mb-6 opacity-90">
                Register now for an exclusive preview of TMW Maxwell 
              </p>
          ...
          <div className={`max-w-6xl mx-auto transition-all duration-1000 delay-500 ${
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-6">
              {[
                ...
                { icon: <MapPin className="w-6 h-6 md:w-8 md:h-8" style={{ color: '#ce001f' }} />, title: "Prime Location in D2", subtitle: "Proven resilience and sustained buyer demand in the Chinatown and Tanjong Pagar area" }
              ].map((benefit, index) => (
                <div 
                  key={index} 
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-6 mb-6">
              {[
                { icon: <Building className="w-6 h-6 md:w-8 md:h-8" style={{ color: '#ce001f' }} />, title: "Blue-Chip Developers", subtitle: "SingHaiyi Group and Chuan Investments bring extensive experience in delivering quality residential developments" },
            ...
            <div className="grid grid-cols-1 md:hidden gap-6">
              ...
              >
                <div className="p-4 flex flex-col items-center text-center space-y-2">
                  ...
                  <h3 className="text-sm text-white font-semibold leading-snug">Prime Location in D2</h3>
                  <p className="text-xs text-gray-300 font-light">Proven resilience and sustained buyer demand in the Chinatown and Tanjong Pagar area</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="font-semibold text-white">Address</p>
                      <p className="text-sm text-gray-300 font-light">31 Tras Street, Singapore, 079934</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
