// Shared press articles data and type
...
export const allArticles: Article[] = [
  {
    ...
    articleContent: `
      <div class="article-content">
        <h2 id="heading-0">KW Singapore debuts with $10m valuation, pledges to disrupt property agency model</h2>
        <img src="https://kwsingapore.s3.ap-southeast-1.amazonaws.com/images/news.jpg" alt="The Real Estate Model of the Future. Built Today." style="width:100%;max-width:600px;margin:24px auto;display:block;" />
        <p>Keller Williams (KW) has officially entered Singapore's real estate market, launching with a seed valuation of S$10 million and a business model that promises to reshape how property consultants work, earn and grow.</p>
        <p>The new agency—spearheaded by PropertyLimBrothers co-founder Melvin Lim—marks the local debut of the Keller Williams Worldwide franchise. But unlike traditional agencies, KW Singapore is betting big on a platform-driven model that offers agents higher commission retention, integrated tech tools and professional development.</p>
        <p>In a significant departure from legacy practices, KW Singapore's consultants can retain up to 94 per cent of their commissions. The firm also equips agents with in-house media support, AI-driven client prospecting, and a modular training curriculum via its KW Training Academy.</p>
        <blockquote style="margin: 16px 0; padding: 12px 20px; background: #222; border-left: 4px solid #B40101; color: #fff; font-style: italic;">
          "The real estate model in Singapore is due for innovation and forward-looking change. Realtors are often treated as extensions of the agency, rather than independent professionals with the potential to build something of their own," said Melvin Lim, Operating Principal of KW Singapore.<br><br>
        ...
        <img src="https://img.tepcdn.com/img-style/simplecrop_article/88304311.jpeg" alt="Melvin Lim, Operating Principal of KW Singapore, on stage giving a sharing on KW" style="width:100%;max-width:600px;margin:24px auto;display:block;" />
        <em style="display:block;text-align:center;color:#aaa;font-size:0.95em;margin-bottom:24px;">Melvin Lim, Operating Principal of KW Singapore, on stage giving a sharing on KW</em>
        <h3 id="heading-1">Riding the wave of digital transformation</h3>
        <p>KW Singapore's entry comes as the Council for Estate Agencies (CEA) pushes for greater digital enablement and flexible infrastructure in the property sector. The agency's tech-forward strategy aims to meet that demand head-on.</p>
        <h3 id="heading-2">Riding the wave of digital transformation</h3>
        <p>According to KW Worldwide president William E. Soteroff, Lim's leadership and the local team's track record made the franchise's expansion into Singapore a natural next step.</p>
        <blockquote style="margin: 16px 0; padding: 12px 20px; background: #222; border-left: 4px solid #B40101; color: #fff; font-style: italic;">
        ...
        <h3 id="heading-3">Responding to the rise of content-first marketing</h3>
        <p>The launch also responds to a notable trend in Singapore's real estate scene: the surge in content marketing by realtors using platforms like TikTok and YouTube to reach younger, digital-first audiences.</p>
        <p>To support this, KW Singapore has developed an in-house Media-as-a-Service capability that offers realtors curated photography, video production, performance marketing services, and AI-powered content creation and distribution.</p>
        <p>While PropertyLimBrothers (PLB) will continue operating as a client-facing media-centric consultancy, KW Singapore is positioned as a separate, consultant-first business. The focus: to help realtors scale their brand, build passive income, and expand their teams through revenue-sharing structures.</p>
        <h3 id="heading-4">Training for a new generation of realtors</h3>
        <p>KW Singapore is also doubling down on training. Its KW Training Academy is designed to upskill both new and experienced consultants in technical areas such as pricing comparison, project benchmarking, and transaction advisory—especially for new launch developments.</p>
        <p>Training is delivered through a blend of in-person and online formats, aimed at supporting consultants with data-led decision-making tools.</p>
        <p>The firm plans to grow its realtor base to 500 by the end of 2025, targeting professionals looking to build their own brand while leveraging KW's support ecosystem.</p>
      </div>
    `
  },
  {
    ...
    imageUrl: "https://itbrief.asia/uploads/story/2025/07/09/modern-singapore-city-skyline-digital-icons-property-market-tech-driven-real-estate.webp",
    ...
    articleContent: `
      <div class="article-content">
        <p><strong>Keller Williams Singapore</strong> has entered the Singapore property market with a seed valuation of SGD $10 million, unveiling a platform-based business model for real estate consultants.</p>
        <p>The agency is led by Melvin Lim, Co-Founder of PropertyLimBrothers, and operates as part of the Keller Williams Worldwide franchise. The new company will focus on enabling realtors to operate with greater independence and efficiency, in line with updated digitalisation targets for the sector and Singapore's broader Smart Nation ambitions.</p>

        <h3 id="heading-0">Consultant-focused model</h3>
        <p>Keller Williams Singapore introduces a structure that allows realtors to retain up to 94% of their commissions. The business model is built upon providing agents with access to in-house media production resources, AI-driven client prospecting technology, and ongoing skills development through the KW Training Academy.</p>
        <p>In discussing the agency's mission and approach, Melvin Lim, Operating Principal of KW Singapore, said:</p>
        <blockquote style="margin: 16px 0; padding: 12px 20px; background: #222; border-left: 4px solid #B40101; color: #fff; font-style: italic;">
        ...
        <h3 id="heading-2">Media as a service and technology integration</h3>
        <p>The firm is responding to new consumer habits by investing in media production and marketing support for realtors. As highlighted in a recent CNA article, more agents are engaging clients through TikTok, YouTube and other digital channels to connect with younger, digitally native property buyers. KW Singapore's Media-as-a-Service provision includes on-site media studios, curated vendors for property marketing, and AI tools to enhance content creation and distribution efforts.</p>
        ...
        <h3 id="heading-3">Autonomy for agents</h3>
        <p>KW Singapore operates independently from PropertyLimBrothers, which continues to function as a client-facing real estate consultancy. KW Singapore's platform is designed for consultants seeking autonomy, diversified income streams, and opportunities to recruit and mentor teams. Agents who bring in additional consultants benefit from an ongoing revenue-sharing model, incorporating sustained earning potential through team-building.</p>

        <h3 id="heading-4">Growth plans</h3>
  ...
  },
  {
    ...
    articleContent: `
      <div class="article-content">
        <h2 id="heading-0">Real Estate Franchise Keller Williams Expands to Singapore</h2>
        <p>US-headquartered real estate agency Keller Williams (KW) is launching a company in Singapore under its international franchising arm, Keller Williams Worldwide.</p>
        ...
        <p>KW Singapore agents will also have access to support services, including in-house media production, AI-led client prospecting, and KW Training Academy, the firm's training curriculum.</p>
        <blockquote style="margin: 16px 0; padding: 12px 20px; background: #222; border-left: 4px solid #B40101; color: #fff; font-style: italic;">
          "Melvin Lim and his team bring a proven track record of innovation, leadership, and success in the Singaporean real estate market," says William E Soteroff, president of Keller Williams Worldwide. "Their dedication to education, client service, and cutting-edge media makes them an ideal partner to lead our growth in Singapore."
        </blockquote>
  ...
  },
  {
    ...
    articleContent: `
      <div class="article-content">
        <h2 id="heading-0">Real Estate Franchise Keller Williams Expands in Singapore</h2>
        <p>US-headquartered real estate agency Keller Williams (KW) is launching a company in Singapore under its international franchising arm, Keller Williams Worldwide.</p>
        <p>KW Singapore will be led by Melvin Lim, who is also the co-founder and CEO of PropertyLimBrothers (PLB). In a press release, KW Singapore says it operates as a standalone business separate from PLB.</p>
        <p>According to the company, KW Singapore will bring a "platform-based business model" to Singapore's property sector, where agents will have a performance-driven structure that could allow them to retain up to 94% of their commissions.</p>
        <p>KW Singapore agents will also have access to support services, including in-house media production, AI-led client prospecting, and KW Training Academy, the firm's training curriculum.</p>
        <p>"Melvin Lim and his team bring a proven track record of innovation, leadership, and success in the Singaporean real estate market," says William E Soteroff, president of Keller Williams Worldwide. "Their dedication to education, client service, and cutting-edge media makes them an ideal partner to lead our growth in Singapore."</p>
        <p>KW Singapore is targeting to have 500 agents on its roster by the end of 2025.</p>
      </div>
    `
  },
  ...
  },
  {
    ...
    link: "https://outfront.kw.com/performance/keller-williams-expands-to-singapore/?utm_source=Facebook&utm_medium=social&utm_campaign=07.16_KWSingapore&utm_content=KW_Across_the_World",
    date: "2025-07-17",
    year: "2025",
